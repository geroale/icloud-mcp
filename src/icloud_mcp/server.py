...
async def calendar_create_event(
    ...
    Args:
        ...
        recurrence: iCal RRULE for recurring events (e.g. "RRULE:FREQ=YEARLY" for annual birthday)
    """
    try:
        return await calendar.create_event(context, summary, start, end, description, location, attendees, calendar_id, recurrence)
    except AuthenticationError as e:
        return {"error": str(e), "status": 401}
    except Exception as e:
        return {"error": str(e), "status": 500}
